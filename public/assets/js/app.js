...
(function () {
  ...
  // DISABLED: Active class is now handled server-side via PHP uri_string() in the layout
  ...
  if (sidebar) {
    // Active class handling disabled - using server-side PHP uri_string() instead
