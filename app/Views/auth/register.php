        ...
        <section class="auth-card" aria-label="Register">
            ...
            <div class="auth-form">
                <header class="form-header">
                    ...
                    <p>Isi data akun untuk mulai masuk ke dashboard invoice.</p>
                </header>
                ...
                <form method="POST" action="<?= site_url('register') ?>">
                    ...
                    <div class="field">
                        ...
                        <input id="name" type="text" name="name" required value="<?= old('name') ?>" placeholder="Your name" autocomplete="name">
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input id="password" type="password" name="password" required minlength="6" placeholder="Minimum 6 characters" autocomplete="new-password">
                    </div>

                    <div class="field">
                        <label for="confirm_password">Confirm password</label>
                        <input id="confirm_password" type="password" name="confirm_password" required placeholder="Repeat your password" autocomplete="new-password">
                    </div>

                    <p class="hint">Default user limits are applied after registration.</p>
                ...
                <p class="switch-link">Already have an account? <a href="<?= site_url('login') ?>">Sign in</a></p>
            </div>
        </section>
    </main>
</body>
