...
<body>
    <div class="no-print" style="text-align:center;margin-bottom:20px;">
        <button onclick="window.print()" style="background:#1b3a5c;color:#fff;border:none;padding:10px 30px;border-radius:6px;font-size:1rem;cursor:pointer;font-weight:600;">🖨️ <?= esc(lang('App.print_invoice')) ?></button>
        <a href="/invoices/<?= $invoice['id'] ?>" style="margin-left:15px;color:#555;text-decoration:none;">← <?= esc(lang('App.back_to_invoice')) ?></a>
    </div>
        ...
        <div class="header">
            <div class="company-info">
                <?php if ($invoice['company_logo']): ?>
                    <img src="/uploads/logos/<?= $invoice['company_logo'] ?>" alt="<?= esc(lang('App.logo_alt')) ?>" style="height:50px;margin-bottom:10px;">
                <?php endif; ?>
